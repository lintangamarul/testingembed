    ...
    <div id="products" class="pt-20 pb-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-4 sm:p-8 rounded-2xl shadow-2xl border border-gray-100">
                <h3 class="text-2xl font-semibold text-primary-dark mb-4 border-b pb-3">Embedded Calculator Demonstration</h3>
                ...
                <h3 class="text-2xl font-semibold text-primary-dark mb-4 border-b pb-3 mt-8">Front Menu Demonstration</h3>
